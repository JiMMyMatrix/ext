...
PROMPT_PRESET="${CORGI_TEST_WINDOW_PROMPT_PRESET:-pet-life-diary-static}"
AUTO_STEPS="${CORGI_TEST_WINDOW_AUTO_STEPS:-execute}"
...
CORGI_TEST_WINDOW_WORKSPACE_MODE="$WORKSPACE_MODE" \
