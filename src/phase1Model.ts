import type {
	...
	ContextSnapshot,
	ControllerRequestMetadata,
	ExecutionWindowModel,
	FeedItem,
	FeedItemBase,
	FeedItemShared,
	ModelAction,
	NonArtifactFeedItemType,
	PermissionRequest,
	PermissionScope,
	PlanReadyRequest,
	RequestCard,
...
export function createInitialModel(now = new Date().toISOString()): ExecutionWindowModel {
	return {
		snapshot: {
			...
			currentGoalRef: undefined,
			currentGoalTitle: undefined,
			currentGoalStepRef: undefined,
			currentGoalStepIndex: undefined,
			goalStepCount: undefined,
			goalStatus: undefined,
			latestGoalDecisionRef: undefined,
