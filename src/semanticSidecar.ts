...
function semanticPrompt(input: SemanticRunnerInput): string {
	return [
		...
		'Question-shaped phrasing can still be governed_work_intent when it clearly asks Corgi to do repo work.',
		'Examples:',
		'- "what happened?" => governor_dialogue',
		'- "analyze the repo" => governed_work_intent',
		'- "can we develop the internet feature?" => governed_work_intent',
		'- "could you review this folder?" => governed_work_intent',
		'- with an active clarification, "architecture" => clarification_reply',
		'- with a pending permission request, "new work request" => block unless it includes the concrete work to do',
