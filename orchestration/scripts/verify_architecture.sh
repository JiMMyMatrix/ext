...
check "Advisory MCP launcher handles Python environment" "rg -n 'ORCHESTRATION_APPROVED_PYTHON|CORGI_PYTHON|/opt/homebrew/bin/python3|PYTHONPATH|mcp_server\\.py|requirements\\.txt' orchestration/scripts/serve_advisory_mcp.py > /dev/null"
